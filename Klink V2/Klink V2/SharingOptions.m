...
- (NSString*) toJSON {
    ...
    [dictionary setValue:[NSNumber numberWithBool:self.shareonfacebook] forKey:an_SHAREONFACEBOOK];
    [dictionary setValue:[NSNumber numberWithBool:self.shareontwitter] forKey:an_SHAREONTWITTER];
