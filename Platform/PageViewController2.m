...
+ (PageViewController2*) createInstanceWithPageID:(NSNumber*)pageID withPageNumber:(NSNumber*)pageNumber {
    PageViewController2* instance = [[PageViewController2 alloc]initWithNibName:@"PageViewController2" bundle:nil];
