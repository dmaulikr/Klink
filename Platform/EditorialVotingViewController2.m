...
@implementation EditorialVotingViewController2
...
+ (EditorialVotingViewController2*) createInstanceForPoll:(NSNumber*)pollID {
    EditorialVotingViewController2* retVal = [[EditorialVotingViewController2 alloc]initWithNibName:@"EditorialVotingViewController2" bundle:nil];
