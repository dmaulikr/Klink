...
#import "UIStrings.h"
 ...
 NSString* const ui_WELCOME_EDITORIAL           = @"You've made it, you are a Bahndr Editor! Only Editors decide what Draft will be published next. Go on, cast your vote for your favorite. Remember Bahndr is forever, guard it well.";

NSString* const ui_LOGIN_REQUIRED = @"While anyone can read Bahndr, only logged-in Bahndrers can write it.\n\n\tJoining Bahndr is easy, just login with your Facebook credentials and you are done!";
